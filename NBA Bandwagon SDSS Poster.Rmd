...
author: "Victor Wilson, Kelly Bodwin, and Eric Tran"
...
references:
  ...
  - id: R-pagedown2
    ...
    - family: Nielsen
      given: Nielsen
    title: 'Nielsen 2019 DMA Rankings'
    issued:
      year: 2019
    URL: https://mediatracks.com/resources/nielsen-dma-rankings-2019/
output:
...
```{r, echo=FALSE}
plt <- ggplot(NBAData, aes(y = log(Popularity), x = Playoffs, fill = Playoffs)) +    geom_boxplot() +  theme(axis.text.x=element_text(angle=45, hjust=1)) + 
  guides(fill = FALSE)
...
$$BWOVerall = BWHeavyFavorite + BWContender - BWDarkHorse$$
